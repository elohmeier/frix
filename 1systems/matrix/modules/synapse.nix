...
in
{
  ...
  services.matrix-synapse = {
    ...
    settings = {
      ...
      password_config = {
        enabled = true;
        policy = { enabled = true; minimum_length = 12; };
      };

      retention = {
        enabled = true;
        default_policy = { min_lifetime = "1d"; max_lifetime = "120d"; };
        purge_jobs = [
      ...
      federation_domain_whitelist = [ serverName "matrix.org" "nerdworks.de" ];
